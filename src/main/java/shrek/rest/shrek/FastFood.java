...
public class FastFood {
	public static GridPane getGridPane() {
		...
		for (int i = 0; i < 10; i++) {
			...
			Image image = new Image("file:/home/ihab/code/Ideaprojects/shrek/src/main/java/shrek/rest/shrek/image/" + menu.get(i + 20).getImageName());
			ImageView iv = new ImageView(image);
			String des = menu.get(i + 20).getDescription();
			iv.setFitWidth(300);
			iv.setFitHeight(300);

			Label name = new Label(menu.get(i + 20).getName());
			name.setStyle("-fx-font: bold normal 24 serif; -fx-text-fill: #B8DE10");

			Label price = new Label("Price: " + menu.get(i + 20).getPrice() + "$");
			price.setStyle("-fx-font: bold normal 24 serif; -fx-text-fill: #B8DE10");

			Label calories = new Label("Quantity: " + menu.get(i + 20).getQuantity());
			calories.setStyle("-fx-font: bold normal 24 serif; -fx-text-fill: #B8DE10");
